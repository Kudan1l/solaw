<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    <div class="container">
        <a class="navbar-brand" href="home.html">SoLAW</a>
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="form.html">Forum</a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="view_artikel.html">Artikel</a>
                </li>
            </ul>

            <div class="d-flex login align-items-center">
              <a id="signupLink" class="nav-link" href="Sign up.html">Sign up</a>
              <a id="loginLink" type="button" class="btn btn-login" href="LOGIN.html">Login</a>
