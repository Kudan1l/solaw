...
@section('sidebar')
    ...
    @if (Auth::check()) <!-- Hanya tampilkan tombol jika pengguna sudah login -->
        <a href="{{ route('threads.create') }}" class="thread">Buat Postingan Baru</a>
    @else <!-- Tampilkan pesan jika pengguna belum login -->
        <p>Silakan <a href="{{ route('login') }}">login</a> untuk membuat thread baru.</p>
    @endif
@endsection
