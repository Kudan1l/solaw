...
<body>
    ...
    <div class="text-center">
        <img src="{{asset('src/img/hukum1.jpg')}}" class="rounded" alt="...">
        <h5>
            SURAT GUGATAN
        </h5>
    </div>
    ...
    <div class="tatacara container-fluid">
        <table class="table align-middle table-striped custom-table">
            ...
            <tbody>
                <tr>
                    <td rowspan="2"> 1. </td>
                    <td rowspan="2"> <b>Kepala Surat</b></td>
                    <td> Nama Pengadilan</td>
                    <td>
                        Cantumkan nama pengadilan yang berwenang.
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        Jika sudah ada, tuliskan nomor perkara (jika sudah terdaftar).
                    </td>
                </tr>
                ...
                <tr class="align-middle">
                    ...
                    <td colspan="3"> Cantumkan nama lengkap, alamat, dan identitas masing-masing pihak yang terlibat
                        (misalnya, nomor KTP).
                ...
                <tr class="align-middle">
                    ...
                    <td colspan="2"> Jelaskan secara rinci apa yang menjadi objek perjanjian (misalnya, barang, jasa,
                        atau kerja sama). </td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        Simpan salinan perjanjian untuk setiap pihak dan pertimbangkan untuk mendaftarkannya pada
                        notaris jika diperlukan untuk keabsahan hukum.
                    </td>
                </tr>
